...
describe('componentCloneInfoForm', function() {
    ...
    beforeEach(function() {
        ...
        var harness = AngularUnitTestHelper.prepareModule('componentCloneInfoFormModule')
            ...
            .and.returnValue(resource)
            .mock('pageService', 'primaryPageForPageTypeExists')
            .and.returnValue(resource)
    ...
    it('GIVEN a content page WHEN onInit is called THEN "catalogVersionContainsPageWithSameTypeCode" should be false', function() {        //GIVEN
