 ...
 */
angular
    .module('seFileValidationServiceModule', [
        'seObjectValidatorFactoryModule',
        'seFileMimeTypeServiceModule'
    ])
     ...
     * Default ACCEPTED_FILE_TYPES: ['jpeg', 'jpg', 'gif', 'bmp', 'tiff', 'tif', 'png', 'pdf'],
     * Default MAX_FILE_SIZE_IN_BYTES: 20 * 1024 * 1024,
     * Update supported file types to support pdf
    ...
    .constant('seFileValidationServiceConstants', {
        ACCEPTED_FILE_TYPES: ['jpeg', 'jpg', 'gif', 'bmp', 'tiff', 'tif', 'png', 'pdf', 'xlsx', 'zip'],
     ...
     */
    .factory('seFileValidationService', function(
        seObjectValidatorFactory,
        seFileObjectValidators,
        seFileValidationServiceConstants,
        seFileMimeTypeService,
        $q
    ) {
        /**
         * @ngdoc method
        ...
        var buildAcceptedFileTypesList = function() {
            ...
            /*return settingsService.getStringList('smartedit.upload.file.type.supported').map(function(fileType) {*/
                return '.' + fileType;
            }).join(',');
        };
        ...
        var validate = function(file, errorsContext) {
            ...
            return seFileMimeTypeService.isFileMimeTypeValid(file).then(
                function() {
