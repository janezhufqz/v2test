...
import './NavigationEditor.scss';(window as any).__smartedit__.addDecoratorPayload('SeComponent', 'NavigationEditorTreeComponent', {
...
export class /* @ngInject */ NavigationEditorTreeComponent implements ISeComponent {
