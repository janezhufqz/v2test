...
}(window as any).__smartedit__.addDecoratorPayload('SeComponent', 'PageSynchronizationPanel', {
...
export class /* @ngInject */ PageSynchronizationPanel implements ISeComponent {
