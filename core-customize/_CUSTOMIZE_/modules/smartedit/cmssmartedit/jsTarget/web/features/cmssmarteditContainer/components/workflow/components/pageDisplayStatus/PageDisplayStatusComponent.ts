...
import './pageDisplayStatus.scss';(window as any).__smartedit__.addDecoratorPayload('SeComponent', 'PageDisplayStatusComponent', {
...
export class /* @ngInject */ PageDisplayStatusComponent implements ISeComponent {
