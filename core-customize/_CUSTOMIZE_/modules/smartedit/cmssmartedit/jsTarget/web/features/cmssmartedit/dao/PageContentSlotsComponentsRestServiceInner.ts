...
@SeInjectable()
export class /* @ngInject */ PageContentSlotsComponentsRestService extends IPageContentSlotsComponentsRestService {
    ...
    private getCachedSlotsToComponentsMapForPageUid(
        ...
        return this.pagesContentSlotsComponentsRestService
            ...
            .then(({ pageContentSlotComponentList }: PageContentSlotComponentResponse) => {
                let componentUuids = pageContentSlotComponentList.map(
                    (pageContentSlotComponent: PageContentSlotComponent) =>
                        pageContentSlotComponent.componentUuid
                );
                componentUuids = Array.from(new Set(componentUuids)); // removing duplicates
                ...
                return this.cmsitemsRestService
                    ...
                    .then((components: CMSItemsResponse) => {
                        ...
                        const allSlotsToComponentsMap: TypedMap<ICMSComponent[]> = pageContentSlotComponentList.reduce(
                            (
