...
import { CmsitemsRestService } from 'cmscommons/dao/cmswebservices/sites/CmsitemsRestService';(window as any).__smartedit__.addDecoratorPayload('SeComponent', 'PermanentlyDeletePageItemComponent', {
...
export class /* @ngInject */ PermanentlyDeletePageItemComponent implements ISeComponent {
    // ------------------------------------------------------------------------
    // Properties
    // ------------------------------------------------------------------------
