...
interface PageApprovalOption {
    ...
    i18nKey: string;
    selected?: boolean;
}(window as any).__smartedit__.addDecoratorPayload('SeComponent', 'PageApprovalSelectorComponent', {
...
export class /* @ngInject */ PageApprovalSelectorComponent implements ISeComponent {
    public isOpen = false;
