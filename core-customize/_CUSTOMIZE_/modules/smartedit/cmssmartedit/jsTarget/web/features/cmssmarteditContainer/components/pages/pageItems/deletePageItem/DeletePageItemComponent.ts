...
import { ManagePageService } from 'cmssmarteditcontainer/services/pages/ManagePageService';(window as any).__smartedit__.addDecoratorPayload('SeComponent', 'DeletePageItemComponent', {
...
export class /* @ngInject */ DeletePageItemComponent implements ISeComponent {
    // ------------------------------------------------------------------------
    // Properties
    // ------------------------------------------------------------------------
