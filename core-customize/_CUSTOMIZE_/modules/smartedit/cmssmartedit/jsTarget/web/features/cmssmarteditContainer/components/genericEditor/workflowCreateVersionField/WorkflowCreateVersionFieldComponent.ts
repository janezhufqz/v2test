...
import {
    ...
    WorkflowDecision,
    WorkflowTemplate
} from 'cmssmarteditcontainer/components/workflow/dtos';(window as any).__smartedit__.addDecoratorPayload('SeComponent', 'WorkflowCreateVersionFieldComponent', {
...
export class /* @ngInject */ WorkflowCreateVersionFieldComponent implements ISeComponent {
