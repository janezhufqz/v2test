...
import './workflowAction.scss';(window as any).__smartedit__.addDecoratorPayload('SeComponent', 'WorkflowActionCommentComponent', {
...
export class /* @ngInject */ WorkflowActionCommentComponent implements ISeComponent {
