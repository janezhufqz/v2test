...
import { WorkflowService } from '../services/WorkflowService';(window as any).__smartedit__.addDecoratorPayload('SeComponent', 'WorkflowInboxBadgeComponent', {
...
export class /* @ngInject */ WorkflowInboxBadgeComponent implements ISeComponent {
