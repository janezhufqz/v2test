...
}(window as any).__smartedit__.addDecoratorPayload('SeComponent', 'VersionItemMenuComponent', {
...
export class /* @ngInject */ VersionItemMenuComponent implements ISeComponent {
