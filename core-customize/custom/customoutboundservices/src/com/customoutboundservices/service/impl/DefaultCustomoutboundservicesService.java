...
public class DefaultCustomoutboundservicesService implements CustomoutboundservicesService
{
	private static final Logger LOG = LoggerFactory.getLogger(DefaultCustomoutboundservicesService.class);
	...
	{
		return DefaultCustomoutboundservicesService.class.getResourceAsStream("/customoutboundservices/sap-hybris-platform.png");
	}
