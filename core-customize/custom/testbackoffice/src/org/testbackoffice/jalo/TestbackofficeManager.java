 ...
 */
package org.testbackoffice.jalo;
...
import org.testbackoffice.constants.TestbackofficeConstants;
 ...
 */
public class TestbackofficeManager extends GeneratedTestbackofficeManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = LoggerFactory.getLogger(TestbackofficeManager.class.getName());
	 ...
	 */
	public static TestbackofficeManager getInstance()
	{
		return (TestbackofficeManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(TestbackofficeConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public TestbackofficeManager() // NOPMD
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of TestbackofficeManager called.");
		}
	}
