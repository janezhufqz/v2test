...
import { ISynchronizationPanelApi, ISyncStatusItem } from './interfaces';(window as any).__smartedit__.addDecoratorPayload('SeComponent', 'SynchronizationPanelComponent', {
...
export class /* @ngInject */ SynchronizationPanelComponent {
    ...
    private _updateStatus(): void {
        ...
        this.getRows().forEach((item) => {
            ...
            if (idx > -1 && item.status !== SynchronizationStatus.InProgress && item.status !== SynchronizationStatus.NotSync) {
