...
import { IPageService, SlotStatus } from 'cmscommons';(window as any).__smartedit__.addDecoratorPayload('SeComponent', 'SlotSynchronizationPanel', {
...
export class /* @ngInject */ SlotSynchronizationPanel implements ISeComponent {
