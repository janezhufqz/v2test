...
import {
    ...
    SeDecorator,
    TypedMap
} from 'smarteditcommons';(window as any).__smartedit__.addDecoratorPayload('Component', 'SyncIndicatorDecorator', {
...
export class /* @ngInject */ SyncIndicatorDecorator extends AbstractDecorator {
