 ...
 */
import { ISeComponent, SeComponent } from 'smarteditcommons';(window as any).__smartedit__.addDecoratorPayload('SeComponent', 'DuplicatePrimaryContentPageLabelComponent', {
...
export class /* @ngInject */ DuplicatePrimaryContentPageLabelComponent implements ISeComponent {
    // ------------------------------------------------------------------------
    // Constants
    // ------------------------------------------------------------------------
