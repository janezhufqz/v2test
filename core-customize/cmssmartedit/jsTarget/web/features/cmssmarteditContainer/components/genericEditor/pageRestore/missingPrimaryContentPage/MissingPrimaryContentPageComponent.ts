...
import { CMSItem, ICMSPage, IPageService } from 'cmscommons';(window as any).__smartedit__.addDecoratorPayload('SeComponent', 'MissingPrimaryContentPageComponent', {
...
export class /* @ngInject */ MissingPrimaryContentPageComponent implements ISeComponent {
