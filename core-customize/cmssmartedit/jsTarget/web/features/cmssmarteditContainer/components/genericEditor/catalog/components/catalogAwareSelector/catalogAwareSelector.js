 ...
 */
angular
    .module('catalogAwareSelectorModule', ['itemSelectorPanelModule', 'yEditableListModule'])
    .controller('CatalogAwareSelectorController', function($q, $log, $translate, lodash) {
        ...
        // Flags
        // CMSX-10736: control if sync itemlist to model
        this.syncFromItemsListToModelDisabled = false;
        ...
        this._syncFromItemsListToModel = function() {
            if (!this.syncFromItemsListToModelDisabled) {
                this.model.length = 0;
                this.itemsList.map(
                    function(item) {
        ...
        this._syncFromModelToItemsList = function() {
            this.syncFromItemsListToModelDisabled = true;
            var itemsFound = {};
            var itemsMissing = [];
