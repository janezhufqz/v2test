...
import { ICMSPage } from 'cmscommons';(window as any).__smartedit__.addDecoratorPayload('SeComponent', 'PageInfoPageNameComponent', {
...
export class /* @ngInject */ PageInfoPageNameComponent implements ISeComponent {
