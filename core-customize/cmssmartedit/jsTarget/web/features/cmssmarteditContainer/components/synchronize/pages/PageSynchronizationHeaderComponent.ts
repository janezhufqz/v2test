...
import { SynchronizationPageConditions } from '../index';(window as any).__smartedit__.addDecoratorPayload('SeComponent', 'PageSynchronizationHeaderComponent', {
...
export class /* @ngInject */ PageSynchronizationHeaderComponent implements ISeComponent {
