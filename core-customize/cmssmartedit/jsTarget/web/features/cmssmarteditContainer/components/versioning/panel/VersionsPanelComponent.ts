...
import './versions.scss';(window as any).__smartedit__.addDecoratorPayload('SeComponent', 'VersionsPanelComponent', {
...
export class /* @ngInject */ VersionsPanelComponent implements ISeComponent {
    // ------------------------------------------------------------------------
    // Properties
    // ------------------------------------------------------------------------
