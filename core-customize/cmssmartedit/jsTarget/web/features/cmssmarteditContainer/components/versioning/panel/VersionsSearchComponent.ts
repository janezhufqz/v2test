 ...
 */
import { ISeComponent, SeComponent } from 'smarteditcommons';(window as any).__smartedit__.addDecoratorPayload('SeComponent', 'VersionsSearchComponent', {
...
export class /* @ngInject */ VersionsSearchComponent implements ISeComponent {
    // ------------------------------------------------------------------------
    // Properties
    // ------------------------------------------------------------------------
