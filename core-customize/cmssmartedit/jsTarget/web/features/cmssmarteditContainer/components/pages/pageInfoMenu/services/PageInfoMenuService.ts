 ...
 */
@SeInjectable()
export class /* @ngInject */ PageInfoMenuService {
    // ------------------------------------------------------------------------
    // Constants
    // ------------------------------------------------------------------------
    ...
    public getPageStructureForViewing(
        ...
        return this.typeStructureRestService
            ...
            .then((structure: CMSItemStructureField[]) => {
                ...
                const descriptionFlag: boolean = this.structureContainsItemByFieldQualifier(structure, "description");
                if (descriptionFlag) {
                ...
                const titleFlag: boolean = this.structureContainsItemByFieldQualifier(structure, "title");
                if (titleFlag) {
                ...
                const labelFlag: boolean = this.structureContainsItemByFieldQualifier(structure, "label");
                if (labelFlag) {
