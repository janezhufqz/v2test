...
import './workflowInbox.scss';(window as any).__smartedit__.addDecoratorPayload('SeComponent', 'WorkflowInboxComponent', {
...
export class /* @ngInject */ WorkflowInboxComponent implements ISeComponent {
    public pageSize = 10;
