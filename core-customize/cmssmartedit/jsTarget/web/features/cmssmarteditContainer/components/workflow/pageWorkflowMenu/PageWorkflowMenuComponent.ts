...
import './pageWorkflowMenu.scss';(window as any).__smartedit__.addDecoratorPayload('SeComponent', 'PageWorkflowMenuComponent', {
...
export class /* @ngInject */ PageWorkflowMenuComponent implements ISeComponent {
