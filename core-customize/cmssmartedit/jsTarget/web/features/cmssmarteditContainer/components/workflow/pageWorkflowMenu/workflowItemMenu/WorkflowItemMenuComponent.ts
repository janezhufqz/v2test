...
}(window as any).__smartedit__.addDecoratorPayload('SeComponent', 'WorkflowItemMenuComponent', {
...
export class /* @ngInject */ WorkflowItemMenuComponent implements ISeComponent {
