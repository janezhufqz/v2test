...
import { CMSTimeService } from 'cmscommons';(window as any).__smartedit__.addDecoratorPayload('SeComponent', 'WorkflowInboxTaskComponent', {
...
export class /* @ngInject */ WorkflowInboxTaskComponent implements ISeComponent {
