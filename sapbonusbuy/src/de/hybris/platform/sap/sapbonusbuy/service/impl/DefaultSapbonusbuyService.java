...
public class DefaultSapbonusbuyService implements SapbonusbuyService
{
	private static final Logger LOG = LoggerFactory.getLogger(DefaultSapbonusbuyService.class);
	...
	public void createLogo(final String logoCode)
	{
		...
		final CatalogUnawareMediaModel media = (CatalogUnawareMediaModel) (existingLogo.isPresent() ? existingLogo.get()
	...
	private Optional<CatalogUnawareMediaModel> findExistingLogo(final String logoCode)
	{
		...
		try
		{
			return Optional.of((CatalogUnawareMediaModel) flexibleSearchService.searchUnique(fQuery));
		}
	...
	{
		return DefaultSapbonusbuyService.class.getResourceAsStream("/sapbonusbuy/sap-hybris-platform.png");
	}
