...
/**
 * This is the extension manager of the Sapbonusbuy extension.
 */
public class SapbonusbuyManager extends GeneratedSapbonusbuyManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = LoggerFactory.getLogger(SapbonusbuyManager.class);
	 ...
	 */
	public static SapbonusbuyManager getInstance()
	{
		return (SapbonusbuyManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(SapbonusbuyConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public SapbonusbuyManager() // NOPMD 
	{
		LOG.debug("constructor of SapbonusbuyManager called.");
	}
	...
	public void init()
	{
		LOG.debug("init() of SapbonusbuyManager called, current tenant: {}", getTenant().getTenantID());
	}
	...
	public void destroy()
	{
		LOG.debug("destroy() of SapbonusbuyManager called, current tenant: {}", getTenant().getTenantID());
	}
