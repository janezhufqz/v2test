 ...
 */
package de.hybris.platform.sap.sapbonusbuy.hmc;
 ...
 * @version ExtGen v4.1
 */
public class SapBonusBuyHMCExtension extends HMCExtension
{
	/** Path to the resource bundles. */
	public static final String RESOURCE_PATH = "localization.sapbonusbuyhmc-locales";
	/** Edit the local|project.properties to change logging behavior (properties log4j.*). */
	@SuppressWarnings("unused")
	private static final Logger LOG = Logger.getLogger(SapBonusBuyHMCExtension.class.getName());
